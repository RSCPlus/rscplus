 ...
 *
 * <p>This implementation is based on the one written by Bob Jenkins, which is available at <a
 * href="http://www.burtleburtle.net/bob/java/rand/Rand.java">
...
public class ISAACCipher {
  ...
  public void reset() {
    for (int i = 0; i < memory.length; i++) memory[i] = 0x00;
    for (int i = 0; i < results.length; i++) results[i] = 0x00;
    a = 0;
    b = 0;
    c = 0;
  }
