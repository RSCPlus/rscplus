...
public class Help {
  ...
  public static void help(
      int page, String commandType) // this is for users who want to read the readme in game
      {
    if (page == 0) {
      Client.displayMessage("@whi@::help is a page based system.", Client.CHAT_QUEST);
      Client.displayMessage(
          "@whi@Type \"::help chats 1\" to get the first help page on quickchat commands",
          Client.CHAT_QUEST);
      Client.displayMessage(
          "@whi@Type \"::help settings 1\" to get the first help page on commands which change settings",
          Client.CHAT_QUEST);
      Client.displayMessage(
          "@whi@Type \"::help misc 1\" to get the first help page for all other commands",
          Client.CHAT_QUEST);
      Client.displayMessage(
      ...
      if (commandType.contentEquals("settings")) { // list text commands e.g. ::bank
        switch (page) {
          case 1:
            ...
            Client.displayMessage(
                "@whi@::togglecolor - Toggle colored text in terminal", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::togglecombat - Toggle combat experience menu", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::togglefatigue - Toggle fatigue alert at 100%", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::togglefatiguedrops - Toggle fatigue drops", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::togglefriendinfo - Toggle Player info for Friends only", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::togglehitbox - Toggle hitboxes for NPC info", Client.CHAT_QUEST);
            break;
          case 2:
            Client.displayMessage("@whi@Page 2 of 3", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::toggleinvcount - Toggle the overlay of current inventory used",
                Client.CHAT_QUEST);
            Client.displayMessage("@whi@::toggleiteminfo - Toggle Item info", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::togglelogindetails - Toggle IP/Dns login details shown at welcome screen",
                Client.CHAT_QUEST);
            Client.displayMessage("@whi@::togglenpcinfo - Toggle NPC info", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::toggleplayerinfo - Toggle Player info", Client.CHAT_QUEST);
            Client.displayMessage("@whi@::toggleroofs - Toggle roof hiding", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::togglestatusdisplay - Toggle Hits/Prayer/Fatigue display",
                Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::togglebuffs - Toggle combat (de)buffs and cooldowns display",
                Client.CHAT_QUEST);
            break;
          case 3:
            Client.displayMessage("@whi@Page 3 of 3", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::toggletwitch - Toggle twitch chat hidden/shown", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::togglebypassattack - Toggle bypass right click attack", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::toggleposition - Toggle Player's position", Client.CHAT_QUEST);
            ...
            Client.displayMessage(
                "@whi@::togglestartsearchedbank <aWord> - Toggle between starting bank on search mode",
                Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@ optionally specify the bank search word", Client.CHAT_QUEST);
            break;
          default:
            Client.displayMessage("@whi@page does not exist", Client.CHAT_QUEST);
        }
      } else if (commandType.contentEquals(
          "chats")) { // list commands which type chat messages e.g. ::cmb
        switch (page) {
          case 1:
            Client.displayMessage("@whi@Page 1 of 2", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::[skillname] - Tells skill level and xp in chat", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::next_[skillname] - Tells how much xp needed until next level in chat",
                Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::total - Shows total level and total xp in chat", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::fatigue - Shows the fatigue percentage accurately in chat",
                Client.CHAT_QUEST);
            Client.displayMessage(
                ...
                Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::cmbnocolor - Mimics osbuddy's !cmb; doesn't use color codes, within character limits",
                Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::bank - brings up the bank interface anywhere", Client.CHAT_QUEST);
            break;
          case 2:
            Client.displayMessage("@whi@Page 2 of 2", Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::xmas - Formats your message in festive Red Green and White colors",
                Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::rainbow - Formats your message in all colors of the rainbow (or at least 6)",
                Client.CHAT_QUEST);
            Client.displayMessage(
                "@whi@::system - Hides your username in chat and then outputs your message",
                Client.CHAT_QUEST);
            break;
          default:
            Client.displayMessage("@whi@page does not exist", Client.CHAT_QUEST);
