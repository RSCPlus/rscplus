...
public class JClassPatcher {
	...
	private void patchGeneric(ClassNode node) {
		...
		while (methodNodeList.hasNext()) {
			...
			hookClassVariable(methodNode, "ua", "fb", "Ljava/awt/image/ImageConsumer;", "Game/Renderer",
					"image_consumer", "Ljava/awt/image/ImageConsumer;", true, true);
			...
			hookClassVariable(methodNode, "e", "Ob", "Ljava/lang/String;", "Game/Client", "pm_enteredText",
					"Ljava/lang/String;", true, true);
			hookClassVariable(methodNode, "client", "Ob", "Ljava/lang/String;", "Game/Client", "pm_enteredText",
					"Ljava/lang/String;", true, true);
			hookClassVariable(methodNode, "e", "x", "Ljava/lang/String;", "Game/Client", "pm_text",
					"Ljava/lang/String;", true, true);
			hookClassVariable(methodNode, "client", "x", "Ljava/lang/String;", "Game/Client", "pm_text",
					"Ljava/lang/String;", true, true);

			hookClassVariable(methodNode, "client", "li", "Lba;", "Game/Renderer", "instance", "Ljava/lang/Object;",
					true, false);
			...
			hookStaticVariable(methodNode, "ua", "h", "[Ljava/lang/String;", "Game/Client", "friends",
					"[Ljava/lang/String;");
			...
			hookStaticVariable(methodNode, "client", "il", "[Ljava/lang/String;", "Game/Client", "strings",
					"[Ljava/lang/String;");

			hookStaticVariable(methodNode, "ac", "x", "[Ljava/lang/String;", "Game/Item", "item_name",
					"[Ljava/lang/String;");
			...
			hookClassVariable(methodNode, "client", "Vk", "[Ljava/lang/String;", "Game/Client", "skill_name",
					"[Ljava/lang/String;", true, false);
			...
			hookClassVariable(methodNode, "client", "Ek", "Llb;", "Game/Camera", "instance", "Ljava/lang/Object;",
					true, false);
			...
			hookClassVariable(methodNode, "client", "Qd", "Ljava/lang/String;", "Game/Client", "pm_username",
					"Ljava/lang/String;", true, true);

			hookClassVariable(methodNode, "client", "wh", "Ljava/lang/String;", "Game/Client", "username_login",
					"Ljava/lang/String;", true, true);
			...
			// Chat menu
			hookClassVariable(methodNode, "client", "yd", "Lqa;", "Game/Menu", "chat_menu", "Ljava/lang/Object;", true,
					false);
			...
			// Quest menu
			hookClassVariable(methodNode, "client", "fe", "Lqa;", "Game/Menu", "quest_menu", "Ljava/lang/Object;",
					true, false);
			hookClassVariable(methodNode, "client", "lk", "I", "Game/Menu", "quest_handle", "I", true, false);

			// Friends menu
			hookClassVariable(methodNode, "client", "zk", "Lqa;", "Game/Menu", "friend_menu", "Ljava/lang/Object;",
					true, false);
			hookClassVariable(methodNode, "client", "Hi", "I", "Game/Menu", "friend_handle", "I", true, false);

			// Spell menu
			hookClassVariable(methodNode, "client", "Mc", "Lqa;", "Game/Menu", "spell_menu", "Ljava/lang/Object;",
					true, false);
			hookClassVariable(methodNode, "client", "Ud", "I", "Game/Menu", "spell_handle", "I", true, false);

			// Player name
			hookClassVariable(methodNode, "client", "wi", "Lta;", "Game/Client", "player_object", "Ljava/lang/Object;",
					true, false);
	...
	private void patchMenu(ClassNode node) {
		...
		while (methodNodeList.hasNext()) {
			...
			if (methodNode.name.equals("e") && methodNode.desc.equals("(II)V")) {
				...
				methodNode.instructions.insertBefore(first, new MethodInsnNode(Opcodes.INVOKESTATIC, "Game/Menu",
						"switchList", "(Ljava/lang/Object;)Z"));
	...
	private void patchData(ClassNode node) {
		...
		while (methodNodeList.hasNext()) {
			...
			if (methodNode.name.equals("a") && methodNode.desc.equals("([BBZ)V")) {
				...
				methodNode.instructions.insertBefore(lastNode, new MethodInsnNode(Opcodes.INVOKESTATIC, "Game/Item",
						"patchItemNames", "()V", false));
			}
		}
	}
				...
				for (;;) {
					...
					if (findNode.getOpcode() == Opcodes.ALOAD && next.getOpcode() == Opcodes.ALOAD) {
						...
						if (invoke.name.equals("addMouseListener"))
							...
							methodNode.instructions.insert(findNode, new FieldInsnNode(Opcodes.PUTSTATIC,
									"Game/MouseHandler", "listener_mouse_motion",
	...
	private void patchClient(ClassNode node) {
		...
		while (methodNodeList.hasNext()) {
			...
			if (methodNode.name.equals("I") && methodNode.desc.equals("(I)V")) {
				...
				while (insnNodeList.hasNext()) {
					...
					if (insnNode.getOpcode() == Opcodes.BIPUSH) {
						...
						if (bipush.operand == -9) {
							...
							methodNode.instructions.insertBefore(insnNode, new FieldInsnNode(Opcodes.GETSTATIC,
									"Client/Settings", "COMBAT_MENU", "Z"));
				...
				while (insnNodeList.hasNext()) {
					...
					if (insnNode.getOpcode() == Opcodes.GETFIELD) {
						...
						if (field.owner.equals("client") && field.name.equals("Ob")
							...
							methodNode.instructions.insert(insnNode, new FieldInsnNode(Opcodes.PUTFIELD, "client",
									"Ob", "Ljava/lang/String;"));
							methodNode.instructions.insert(insnNode, new MethodInsnNode(Opcodes.INVOKESTATIC,
									"Game/Client", "processPrivateCommand", "(Ljava/lang/String;)Ljava/lang/String;"));
							methodNode.instructions.insert(insnNode, new FieldInsnNode(Opcodes.GETFIELD, "client",
									"Ob", "Ljava/lang/String;"));
				...
				methodNode.instructions.insertBefore(insnNode, new FieldInsnNode(Opcodes.GETSTATIC, "e", "Mb",
						"[Ljava/lang/String;"));
				methodNode.instructions.insertBefore(insnNode, new VarInsnNode(Opcodes.ALOAD, 0));
				methodNode.instructions.insertBefore(insnNode, new FieldInsnNode(Opcodes.GETFIELD, "client", "Tb",
						"[Lta;"));
				...
				methodNode.instructions.insertBefore(insnNode, new InsnNode(Opcodes.AALOAD));
				methodNode.instructions.insertBefore(insnNode, new MethodInsnNode(Opcodes.INVOKESTATIC, "Game/Client",
						"drawNPC", "(IIIILjava/lang/String;)V"));
				...
				methodNode.instructions.insertBefore(insnNode, new VarInsnNode(Opcodes.ILOAD, 7));
				methodNode.instructions.insertBefore(insnNode, new VarInsnNode(Opcodes.ALOAD, 0));
				methodNode.instructions.insertBefore(insnNode, new FieldInsnNode(Opcodes.GETFIELD, "client", "rg",
						"[Lta;"));
				methodNode.instructions.insertBefore(insnNode, new VarInsnNode(Opcodes.ILOAD, 8));
				methodNode.instructions.insertBefore(insnNode, new InsnNode(Opcodes.AALOAD));
				methodNode.instructions.insertBefore(insnNode, new FieldInsnNode(Opcodes.GETFIELD, "ta", "C",
						"Ljava/lang/String;"));
				methodNode.instructions.insertBefore(insnNode, new MethodInsnNode(Opcodes.INVOKESTATIC, "Game/Client",
						"drawPlayer", "(IIIILjava/lang/String;)V"));
				...
				// Format
				methodNode.instructions.insert(lastNode, new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "da", "b", "(I)V",
						false));
				...
				// Write byte
				methodNode.instructions.insert(lastNode, new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "ja", "c", "(II)V",
						false));
				methodNode.instructions.insert(lastNode, new IntInsnNode(Opcodes.BIPUSH, -80));
				methodNode.instructions.insert(lastNode, new FieldInsnNode(Opcodes.GETSTATIC, "Client/Settings",
						"COMBAT_STYLE", "I"));
				...
				// Create Packet
				methodNode.instructions.insert(lastNode, new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "da", "b", "(II)V",
						false));
				...
				// Client init_game
				methodNode.instructions.insert(lastNode, new MethodInsnNode(Opcodes.INVOKESTATIC, "Game/Client",
						"init_game", "()V", false));
				...
				methodNode.instructions.insertBefore(findNode, new MethodInsnNode(Opcodes.INVOKESTATIC, "Game/Client",
						"init_login", "()V", false));
				...
				methodNode.instructions.insertBefore(findNode, new FieldInsnNode(Opcodes.PUTSTATIC, "Game/Client",
				...
				methodNode.instructions.insert(lastNode, new FieldInsnNode(Opcodes.GETSTATIC, "Game/KeyboardHandler",
						"dialogue_option", "I"));
				methodNode.instructions.insert(lastNode, new FieldInsnNode(Opcodes.GETFIELD, "da", "f", "Lja;"));
				methodNode.instructions.insert(lastNode, new FieldInsnNode(Opcodes.GETFIELD, "client", "Jh", "Lda;"));
				methodNode.instructions.insert(lastNode, new VarInsnNode(Opcodes.ALOAD, 0));
					...
					if (insnNode.getOpcode() == Opcodes.GETFIELD) {
						...
						if (field.owner.equals("client") && field.name.equals("yj")) {
							...
							if (nextNode.getOpcode() == Opcodes.IFNE) {
								...
								methodNode.instructions.insert(nextNode, new FieldInsnNode(Opcodes.GETSTATIC,
										"Client/Settings", "HIDE_ROOFS", "Z"));
							}
						}
					}
				...
				while (insnNodeList.hasNext()) {
					...
					if (insnNode.getOpcode() == Opcodes.PUTFIELD) {
						...
						if (field.owner.equals("client") && field.name.equals("Fg")) {
							...
							methodNode.instructions.insert(insnNode, new FieldInsnNode(Opcodes.PUTSTATIC,
									"Client/Settings", "COMBAT_STYLE", "I"));
							methodNode.instructions.insert(insnNode, new FieldInsnNode(Opcodes.GETFIELD, "client",
									"Fg", "I"));
							methodNode.instructions.insert(insnNode, new VarInsnNode(Opcodes.ALOAD, 0));
						}
			...
			} else if (methodNode.name.equals("a")
					&& methodNode.desc
	...
	private void patchRenderer(ClassNode node) {
		...
		while (methodNodeList.hasNext()) {
			...
			if (methodNode.desc.equals("(Ljava/awt/Graphics;III)V")) {
				...
				methodNode.instructions.insert(findNode, new FieldInsnNode(Opcodes.GETFIELD, node.name, imageNode.name,
						imageNode.desc));
				...
				if (methodNode.desc.equals("(ILtb;)V")) {
					...
					while (insnNodeList.hasNext()) {
						...
						if (insnNode.getOpcode() == Opcodes.ALOAD && nextNode.getOpcode() == Opcodes.ICONST_0) {
							...
							methodNode.instructions.insert(insnNode, new MethodInsnNode(Opcodes.INVOKESPECIAL,
			...
			if (opcode == Opcodes.GETFIELD || opcode == Opcodes.PUTFIELD) {
				...
				if (field.owner.equals(owner) && field.name.equals(var) && field.desc.equals(desc)) {
					if (opcode == Opcodes.GETFIELD && canWrite) {
						methodNode.instructions.insert(insnNode, new FieldInsnNode(Opcodes.GETSTATIC, newClass, newVar,
								newDesc));
						...
						methodNode.instructions.insert(insnNode, new FieldInsnNode(Opcodes.PUTSTATIC, newClass, newVar,
								newDesc));
					}
				}
			}
	...
	private void hookStaticVariable(MethodNode methodNode, String owner, String var, String desc, String newClass,
			String newVar, String newDesc) {
		Iterator<AbstractInsnNode> insnNodeList = methodNode.instructions.iterator();
		while (insnNodeList.hasNext()) {
			AbstractInsnNode insnNode = insnNodeList.next();
