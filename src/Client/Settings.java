...
public class Settings {
  ...
  public static void definePresets(Properties props) {
    ...
    SHOW_LAST_MENU_ACTION.put("default", true);
    SHOW_LAST_MENU_ACTION.put("heavy", true);
    SHOW_LAST_MENU_ACTION.put("all", true);
    SHOW_LAST_MENU_ACTION.put("custom", getPropBoolean(props, "show_buffs", SHOW_LAST_MENU_ACTION.get("default")));
  ...
  public static void save(String preset) {
    try {
      ...
      props.setProperty("show_last_menu_action", Boolean.toString(SHOW_LAST_MENU_ACTION.get(preset)));
