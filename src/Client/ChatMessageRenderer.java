...
public class ChatMessageRenderer {
    ...
    public static StyledDocument renderChatMessages(ArrayList<ChatMessage> chatMessages, boolean showChatTypeLabel) {
    ...
    public static void renderChatMessage(Document document, ChatMessage chatMessage, boolean showChatTypeLabel) {
